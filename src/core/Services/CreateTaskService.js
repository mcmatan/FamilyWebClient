...
import {pickedType, selectedDay, unSelectedDay, createTaskStep, dateChanged, taskCreationHasFinished} from "../actions/CreateTaskActions";
...
class CreateTaskService {
    ...
    taskCreationHasFinished(createTaskReducer) {
        ...
        const timesFilterdWithNoNullOrUndefiend = createTaskReducer.dates.filter(function(n){ return n != undefined });

        const timesStrings = timesFilterdWithNoNullOrUndefiend.map(function(dateString) {
